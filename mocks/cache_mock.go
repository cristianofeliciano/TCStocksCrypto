...
import (
	...
	cache "github.com/tradersclub/TCUtils/cache"
	reflect "reflect"
	time "time"
)
...
func (m *MockCache) Get(ctx context.Context, key string, v interface{}) bool {
	m.ctrl.T.Helper()
...
func (m *MockCache) Set(ctx context.Context, key string, v interface{}) bool {
	m.ctrl.T.Helper()
